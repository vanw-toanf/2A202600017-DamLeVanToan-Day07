...
|-----------|----------|----------------------|-----------|----------|
| Tôi (2A202600017) | FixedSize | 7.1 | Đơn giản, tốc độ nhanh. | Hay bị "gãy" thông tin ở ranh giới chunk. |
| Teamate A  | Recursive | 7.6 | Giữ ngữ cảnh phân cấp rất tốt. | Tốn nhiều chunk hơn. |
| Teammate B | Sentence | 7.4 | Cấu trúc câu sạch sẽ. | Mất liên kết giữa các câu trong cùng đoạn. |
